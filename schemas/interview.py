...
class InterviewQuestion(BaseModel):
    ...
    target_field: str = Field(
        ...
        examples=["project_goal", "business_rules", "edge_cases", "data_flow", "constraints", "target_persona"]
    )
...
class CompletenessEval(BaseModel):
    """완료도 평가 노드의 출력 스키마"""
    project_goal: bool = Field(description="프로젝트 목적/동기 파악 여부")
    ...
    score: float = Field(ge=0.0, le=1.0, description="전체 완료도 점수 (0.0 ~ 1.0, True 항목 수/6.0)")
